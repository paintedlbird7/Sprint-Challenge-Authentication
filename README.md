...
Sessions is a way to store data for individual users against a unique session ID.

1. What does bcrypt do to help us store passwords in a secure manner.

To hash passwords, not encrypt because hackers can get to the password when encrypted but with hashing it gives you random letters & numbers instead of the actual password.


1. What does bcrypt do to slow down attackers?

To hash passwords, not encrypt because hackers can get to the password when encrypted but with hashing it gives you random letters & numbers instead of the actual password.  This makes it slower for attackers to get to the passwords or delicate data.
